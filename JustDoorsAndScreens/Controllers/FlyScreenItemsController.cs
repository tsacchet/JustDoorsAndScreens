...
namespace JustDoorsAndScreens.Controllers
{
    public class FlyScreenItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FlyScreenItemsID,QuoteID,ColorTypeID,FlyScreenTypeID,Width,Depth,Qty,Cost")] FlyScreenItem flyScreenItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult CreateFlyScreenItem([Bind(Include = "FlyScreenItemsID,QuoteID,ColorTypeID,FlyScreenTypeID,Width,Depth,Qty,Cost")] FlyScreenItem flyScreenItem)
        {
            if (ModelState.IsValid)
            {
                db.FlyScreenItems.Add(flyScreenItem);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditFlyScreenItem([Bind(Include = "FlyScreenItemsID,QuoteID,ColorTypeID,FlyScreenTypeID,Width,Depth,Qty,Cost")] FlyScreenItem flyScreenItem)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FlyScreenItemsID,QuoteID,ColorTypeID,FlyScreenTypeID,Width,Depth,Qty,Cost")] FlyScreenItem flyScreenItem)
        {
            if (ModelState.IsValid)
            {
                db.Entry(flyScreenItem).State = EntityState.Modified;
